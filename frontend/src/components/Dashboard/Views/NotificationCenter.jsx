                ...
                {isLoading ? (
                    ...
                    <div className="divide-y divide-slate-50">
                        {filteredNotifications.map((notif) => (
                            <div 
                                key={notif.id}
                                className={`group p-6 md:p-8 flex flex-col md:flex-row gap-6 transition-all hover:bg-slate-50/50 ${!notif.isRead ? 'bg-blue-50/20' : ''}`}
                            >
                                ...
                                <div className="flex-1 space-y-2">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                                        <div className="flex items-center gap-2">
                                            <h3 className={`text-lg font-bold ${!notif.isRead ? 'text-slate-900' : 'text-slate-600'}`}>
                                                {notif.title}
                                            </h3>
                                            {!notif.isRead && (
                    ...
                    <div className="p-20 flex flex-col items-center justify-center text-center space-y-6">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800">No Notifications Found</h3>
                            <p className="text-slate-500 font-medium mt-1 uppercase tracking-widest text-[10px]">Clean Slate Archive</p>
                        </div>
                    </div>
                )}
            </div>
